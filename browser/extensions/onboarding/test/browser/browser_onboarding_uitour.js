...
async function triggerUITourHighlight(tourName, tab) {
  ...
  BrowserTestUtils.synthesizeMouseAtCenter(
    `#onboarding-tour-${tourName}`,
    {},
    tab.linkedBrowser
  );
  BrowserTestUtils.synthesizeMouseAtCenter(
    `#onboarding-tour-${tourName}-button`,
    {},
    tab.linkedBrowser
  );
}
...
add_task(async function test_clean_up_uitour_after_closing_overlay() {
  ...
  await SpecialPowers.pushPrefEnv({
    set: [["browser.onboarding.newtour", "library"]],
  });
  ...
  is(
    ...
    "library",
    "UITour should highlight library"
  );
  ...
  is(
    highlight.state,
    "closed",
    "Should close UITour highlight after closing the overlay by clicking the overlay"
  );
  ...
  is(
    highlight.state,
    "closed",
    "Should close UITour highlight after closing the overlay by clicking the skip-tour button"
  );
  BrowserTestUtils.removeTab(tab);
});

add_task(
  async function test_clean_up_uitour_after_navigating_to_other_tour_by_keyboard() {
    resetOnboardingDefaultState();
    await SpecialPowers.pushPrefEnv({
      set: [["browser.onboarding.newtour", "singlesearch,customize"]],
    });
    ...
    is(
      highlight.getAttribute("targetName"),
      "customize",
      "UITour should highlight customize"
    );
    ...
    is(
      highlight.state,
      "closed",
      "Should close UITour highlight after navigating to another tour by keyboard"
    );
    BrowserTestUtils.removeTab(tab);
  }
);
...
add_task(
  async function test_clean_up_uitour_after_navigating_to_other_tour_by_mouse() {
    resetOnboardingDefaultState();
    await SpecialPowers.pushPrefEnv({
      set: [["browser.onboarding.newtour", "singlesearch,customize"]],
    });
    ...
    is(
      highlight.state,
      "closed",
      "Should close UITour highlight after navigating to another tour by mouse"
    );
    BrowserTestUtils.removeTab(tab);
  }
);
...
add_task(async function test_clean_up_uitour_on_page_unload() {
  ...
  is(
    highlight.state,
    "closed",
    "Should close UITour highlight after page unloaded"
  );
  BrowserTestUtils.removeTab(tab);
});
...
add_task(async function test_clean_up_uitour_on_window_resize() {
  ...
  is(
    highlight.state,
    "closed",
    "Should close UITour highlight after window resized"
  );
