add_task(async function test_show_click_auto_complete_tour_in_notification() {
  ...
  await SpecialPowers.pushPrefEnv({
    set: [["browser.onboarding.newtour", "customize,library"]],
  });
  ...
  is(
    "onboarding-tour-customize",
    activeNavItemId,
    "the active tour should be the previous shown tour"
  );
  ...
  is(
    ...
    targetTourId,
    "correctly show the click-autocomplete-tour in notification"
  );
