...
add_task(async function test_onboarding_overlay_button() {
  ...
  await ContentTask.spawn(tab.linkedBrowser, {}, function() {
    ...
    is(
      button.firstElementChild.getAttribute("role"),
      "presentation",
...
add_task(async function test_onboarding_notification_bar() {
  ...
  await ContentTask.spawn(tab.linkedBrowser, {}, function() {
    ...
    is(
      footer.getAttribute("aria-labelledby"),
      doc.getElementById("onboarding-notification-tour-title").id,
      "Notification bar should be labelled by the notification tour title text"
    );

    is(
      footer.getAttribute("aria-live"),
      "polite",
    ...
    [
      ...
      is(
        doc.getElementById(id).getAttribute("role"),
        "presentation",
...
add_task(async function test_onboarding_overlay_dialog() {
  ...
  await assertModalDialog(browser, {
    visible: true,
    focusedId: "onboarding-overlay-dialog",
  });
